const nameUser: string = 'Priscilla';
const idade: number = 31;
const statusUser: number = 3;
...
for(let c:number = yearFactory; c >= 1920; c--) {
    console.log(c)
}

console.log("-------------------------------------")

for(let d:number = yearFactory; d >= 1920; d = d-10 /*ou d -= 10*/) {
...
console.log("-------------------------------------")
for(let tabNum:number = 0; tabNum <= 10; tabNum++) {
